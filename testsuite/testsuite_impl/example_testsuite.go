...
import (
	"github.com/galenmarchetti/kurtosis-onboarding-test/testsuite/testsuite_impl/my_custom_test"
...
func (suite ExampleTestsuite) GetTests() map[string]testsuite.Test {
	tests := map[string]testsuite.Test{
		"myCustomTest": my_custom_test.NewMyCustomTest(suite.myCustomServiceImage),
	}
